#Program: Autonomous SunFounder Picar-V Line Follower San Luis 2023
#Version: 1.0
...
def sendCommands(borderSensorOutput, goalSensorOuput):
    ...
    if goalSensorOuput["centroid"]:
        recovery, goal, velocity = False, True, MAXIMUM_VELOCITY
        steering = getParameters(goalSensorOuput["centroid"])["steering"]
    elif borderSensorOutput["middlePoint"] and not goal:
        recovery = False
